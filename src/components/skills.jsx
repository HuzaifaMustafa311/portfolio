    ...
    <>
      <section id="skills" className="bg-[linear-gradient(135deg,_#1e3c72,_#2a5298)] bg-cover bg-center text-white py-12 px-4 sm:px-6">
        <div className="container mx-auto">
          <h2 className="text-3xl text-center font-bold mb-4 sm:mb-6">Skills</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {skills.map((data) => (
              <div
                key={data.id}
                className="relative group border-white border-2 cursor-pointer rounded-lg p-4 text-center overflow-hidden"
              >
