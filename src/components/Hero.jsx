    ...
    return (
        <div id="Home">
            <motion.section
                ...
                className="relative grid sm:min-h-[70vh] min-h-[91vh] mt-16 place-content-center overflow-hidden bg-gray-950 px-4 py-20 text-gray-200"
            >
                <div className="relative z-10 flex flex-col items-center">
                    <div className="animate-superman h-[150px] w-[150px] rounded-full flex justify-center items-center">
                        <img src={profileimg} className="h-[150px] w-[100%] border-[4px] border-solid object-cover rounded-[100%]" alt="" />
                    </div>
                    <motion.h1
                        animate={{ y: [0, -20, 0] }}
                        transition={{
                        ...
                        className="bg-gradient-to-br from-white to-gray-400 bg-clip-text mt-6 text-center text-2xl font-medium leading-tight text-transparent sm:text-4xl sm:leading-tight md:text-4xl lg:text-5xl md:leading-tight"
                    >
                    ...
                    >
                        <a className="px-20" href={pdf} download="Huzaifa_Mustafa_Frontend_Developer_Resume.pdf">Get Resume</a>
                    </motion.button>

                    <div className="flex flex-row items-center text-gray-400 mt-10">

                        <a
                            href="https://www.linkedin.com/in/huzaifa-mustafa-frontend-developer/"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="bg-[linear-gradient(0deg,_#243971_0%,_#5fc6ff_100%)] hover:shadow-[0_0_5px_#ffffff,0_0_5px_#ffffff] text-gray-100 transition-shadow duration-500 px-4 py-4 me-3 border-2 rounded-full"
                        >
                            <svg
