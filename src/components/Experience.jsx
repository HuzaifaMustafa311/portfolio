    ...
    return (
        <div className="py-10 bg-gray-50 dark:bg-[#0f1632]" id="Experience">
            <div className="container mx-auto px-6">
                <h1 className="text-center text-2xl dark:text-white font-bold mb-6">Experience</h1>
                <div className="flex flex-wrap justify-center gap-6">
                    {experience.map((data) => (
                        <div
                            key={data.id}
                            className="max-w-[800px] max-h-[165px] h-[165px] shadow-[0px_5px_15px_rgb(40_38_105_/_54%)] cursor-pointer hover:bg-[#bcccf1] dark:hover:bg-[#3361af] bg-white dark:bg-[#284f92] rounded-lg flex overflow-hidden"
                        >
                            {/* Image Section */}
